...
<div id="content" class="content"  ng-controller="requestDataController">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Circular For <?php echo $cir_title; ?><</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Circular <small><?php echo $cir_title; ?></small></h1>
    <!-- end page-header -->
        ...
        <div class="col-md-4 panel  panel-inverse">
            <div class="panel-body">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        <legend>Add Circular For <?php echo $cir_title; ?></legend>
                    ...
                    <ul class="media-list media-list-with-divider">
                        ...
                        <li class="media media-sm" ng-repeat="data in resultData.list">
                            <a class="media-left" href="javascript:;">
                                <img src="<?php echo base_url(); ?>assets/svgicon/circular.svg" alt="" class="media-object rounded-corner">
                            </a>
