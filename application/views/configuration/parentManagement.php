...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Parents Management <small></small></h1>
    <!-- end page-header -->

    <!-- begin panel -->
    <div class="panel panel-inverse" data-sortable-id="form-stuff-5">
        <div class="panel-heading">
            <h4 class="panel-title">Add Parent</h4>
        </div>
        <div class="panel-body">
            <form class="form-inline" action="#" method="POST">
                ...
                <div class="form-group m-r-10">
                    <input type="text" name="name" class="form-control" id="exampleInputEmail2" placeholder="Parent Name" required="">
                </div>
                <div class="form-group  m-r-10" >
                ...
                <button type="submit" name="adduser" class="btn btn-sm btn-primary m-r-5">Add Parent</button>
