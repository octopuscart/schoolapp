                        ...
                        <li class="media media-sm" >
                            ...
                            <div class="media-body">
                                ...
                                <p>
                                    ...
                                    <button class="btn btn-sm btn-danger pull-right" ng-click="deleteData(data.id)"><i class="fa fa-trash"></i></button>

                                    <button class="btn btn-sm btn-success pull-right m-r-5" ng-click="approveData(data.id)"><i class="fa fa-check"></i> Approve</button>
